...
@section('content')
    <div class="relative flex-1 w-full overflow-hidden font-grotesk flex flex-col p-0 m-0">
        ...
        @auth
        <div id="coulee-details-modal" class="hidden absolute inset-0 z-[1003] bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 pointer-events-auto">
            <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col">
                <div class="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                    ...
                    <button id="coulee-details-close" class="text-slate-400 hover:text-slate-600 active:scale-95 transition-transform bg-transparent border-none cursor-pointer">
                ...
                <div class="p-5 space-y-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Description (Optionnelle)</label>
                        <textarea id="coulee-description" placeholder="Décrivez le problème ou l'amélioration en détail..." rows="3"
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 text-sm text-slate-700 outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-all resize-none placeholder:text-slate-400"></textarea>
                    </div>
                    <div>
                ...
                <div class="p-4 border-t border-slate-100 flex gap-3">
                    ...
                    <button id="coulee-details-submit" class="flex-1 py-3 rounded-xl text-sm font-semibold text-white bg-amber-500 hover:bg-amber-600 active:scale-95 transition-all border-none cursor-pointer">Enregistrer</button>
                </div>
            </div>
        </div>
        @endauth
        ...
        <div id="coulee-mode-overlay" class="hidden absolute inset-0 z-[1002] flex flex-col pointer-events-none">
            <div class="pointer-events-auto bg-amber-500 text-white flex items-center justify-between px-4 py-3 shadow-lg">
                <div class="flex items-center gap-2 text-sm font-semibold">
                    ...
                    Cliquez sur la carte pour placer l'emplacement du problème
                </div>
            ...
            <div id="coulee-confirm-bar" class="hidden pointer-events-auto mt-auto bg-white border-t border-slate-100 px-4 py-6 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] flex items-center gap-3">
