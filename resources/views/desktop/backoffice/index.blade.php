            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-100">
                        <th
                            class="text-left px-3 sm:px-6 py-3 text-[11px] font-mono font-bold uppercase tracking-widest text-slate-400">
                            Utilisateur</th>
                        <th
                            class="text-left px-3 sm:px-6 py-3 text-[11px] font-mono font-bold uppercase tracking-widest text-slate-400 hidden sm:table-cell">
                            Email</th>
                        <th
                            class="text-left px-3 sm:px-6 py-3 text-[11px] font-mono font-bold uppercase tracking-widest text-slate-400">
                            Rôle</th>
                        <th
                            class="text-left px-3 sm:px-6 py-3 text-[11px] font-mono font-bold uppercase tracking-widest text-slate-400 hidden md:table-cell">
                            Inscrit le</th>
                        <th
                            class="text-right px-3 sm:px-6 py-3 text-[11px] font-mono font-bold uppercase tracking-widest text-slate-400">
                            Actions</th>
                    </tr>
                </thead>
                        ...
                        <tr id="row-{{ $user->id }}" class="group hover:bg-slate-50/60 transition-colors">
                            <td class="px-3 sm:px-6 py-3 sm:py-4">
                                <div class="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <div>
                                        <a href="{{ route('backoffice.show', $user->id) }}"
                                            class="font-bold text-[#222a60] hover:underline">
                            ...
                            <td
                                class="px-3 sm:px-6 py-3 sm:py-4 text-slate-500 text-[13px] font-grotesk hidden sm:table-cell">
                                {{ $user->email }}</td>
                            <td class="px-3 sm:px-6 py-3 sm:py-4">
                                @php
                                    $roleColors = [
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 text-slate-400 text-[12px] font-mono hidden md:table-cell">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 text-right">
                                <div class="flex items-center justify-end gap-1.5 sm:gap-2">
                                    @if ($user->id !== auth()->id())
                                        <a href="#edit-{{ $user->id }}"
                                            class="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 bg-sv-blue/5 hover:bg-sv-blue/10 text-sv-blue text-[12px] font-bold font-grotesk rounded-lg transition-colors cursor-pointer no-underline">
                                        ...
                                        <a href="#delete-{{ $user->id }}"
                                            class="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-500 text-[12px] font-bold font-grotesk rounded-lg transition-colors cursor-pointer no-underline">
                                            <svg width="13" height="13" fill="none" stroke="currentColor"
                                                stroke-width="2" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round"
